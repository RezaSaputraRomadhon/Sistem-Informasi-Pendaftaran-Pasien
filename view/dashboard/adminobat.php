                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Kategori Obat</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $kategori['total'] ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Jenis Obat</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jenis['total'] ?></div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-dark-blue">Total Uang Pada Tahun <?= date('Y') ?></h6>
